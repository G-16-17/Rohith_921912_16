...
public class MoviecruiserApplication {
	...
	private static void testModifyMovie() {
		LOGGER.info("Start");
		Movie newMovie = new Movie(2, "Ant Man", "$2,518,812,988", true, DateUtil.convertToDate("29/08/2019"),
				"Fictional", true);
	...
	private static void testSaveAllMovies() {
		...
		movie = new Movie(7, "Captain Marvel", "$1,518,812,988", true, DateUtil.convertToDate("12/04/2018"), "Fiction",
				false);
		saveMovieList.add(movie);
